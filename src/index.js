var bio1 = "Guenter Råler is a producer/DJ inspired by experimental club, grime and trance. Her style is eclectic and unpredictable, always mixing unconventionally."
var bio2 = "Sukubratz bio here!"
var bio3 = "Insan's Bio here!"
...
function handleBio1() {
  ...
  popup.classList.toggle("show");
  document.querySelector("#m1").innerHTML = `${bio1}`
}

function handleBio2() {
  var popup = document.getElementById("m2");
  popup.classList.toggle("show");
  document.querySelector("#m2").innerHTML = `${bio2}`
}
function handleBio3() {
  var popup = document.getElementById("m3");
  popup.classList.toggle("show");
  document.querySelector("#m3").innerHTML = `${bio3}`
}
function handleMix4() {
